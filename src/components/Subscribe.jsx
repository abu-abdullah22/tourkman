...
const Subscribe = () => {
    return (
        <section className="py-6 dark:bg-gray-300 dark:text-gray-900 my-20 border-y-2 border-[#99857F]">
             <h2 className="text-4xl text-center my-12 italic">Hit the Subscribe and Stay with us</h2>
        <div className="container mx-auto flex flex-col justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row">
            ...
            <div className="flex flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
                <div className="flex flex-row">
                    <input type="text" placeholder="tourkman@email.com" className="w-3/5 p-3 rounded-l-lg sm:w-2/3" />
