    ...
    return (
        <div className="navbar bg-base-100 mt-3">
            <div className="navbar-start">
                ...
                <Link to={'/'} className="btn bg-[#79A79A] text-white text-3xl hover:bg-[#80665F] italic">TourkMan</Link>
            </div>
            ...
            <label className="cursor-pointer grid place-items-center mr-6" onChange={handleToggle}>
          <input
            type="checkbox"
